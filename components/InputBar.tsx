...
import { MicIcon, MicOffIcon, PlayIcon, PauseIcon, Trash2Icon, SendIcon } from "lucide-react";
      ...
      {recordedBlob ? (
        ...
        <>
          ...
          <Button
            ...
            className="rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-[0_0_20px_rgba(var(--primary),0.3)] transition-all duration-300 hover:scale-105 w-12 sm:w-14 h-12 sm:h-14 flex items-center justify-center disabled:opacity-50 disabled:hover:scale-100"
          >
            <SendIcon className="w-5 h-5" />
          </Button>
        </>
